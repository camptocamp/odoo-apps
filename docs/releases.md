...
long as the build is green!) and push it on the registry as `camptocamp/sensefly_odoo:x.y.z`
...
* Paul tests the image `camptocamp/sensefly_odoo:9.4.0` and oops, it seems he
