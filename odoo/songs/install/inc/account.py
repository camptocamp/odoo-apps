...
@anthem.log
def account_config_settings_inc(ctx):
    """ Setup account.config.settings for senseFly Inc """
...
If the amount has already been paid, please disregard this notice. Otherwise,
please forward us the total amount stated below.
...
@anthem.log
def main(ctx):
    account_config_settings_inc(ctx)
