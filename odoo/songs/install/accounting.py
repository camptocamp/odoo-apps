...
def settings(ctx):
    ...
    ctx.env['account.config.settings'].create({
        ...
        'overdue_msg': u'Dear Sir/Madam,\n\nOur records indicate that some '
                       u'payments on your account are still due. Please find '
                       u'details below.\nIf the amount has already been paid, '
                       u'please disregard this notice. Otherwise, please '
                       u'forward us the total amount stated below.\nIf you '
                       u'have any queries regarding your account, Please '
